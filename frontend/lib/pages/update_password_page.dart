...
import 'package:password_generator/pages/update_generator.dart';
...
class _UpdatePasswordPageState extends State<UpdatePasswordPage> {
                      ...
                      itemBuilder: (context, index) {
                        return Column(
                          children: [
                            ...
                            Row(
                              children: [
                                CustomThemeButton(text: 'Update Password', onPressed: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Update_Password(site: apiAppName, username: apiUsernameAndPassword[index]['userName'])));
                                }),
                                const SizedBox(width: 10,),
                                CustomThemeButton(text: 'Generate New Password', onPressed: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateGenerator(site: apiAppName, username: apiUsernameAndPassword[index]['userName']),));
                                })
                              ],
                            )
                          ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
        AppBar(title: const Text('UpdatePasswordPage'),),
      body:
      Padding(
